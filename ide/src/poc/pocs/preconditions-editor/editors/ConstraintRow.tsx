...
/** One constraint as a table row: left operand · operator · right operand. */
export function ConstraintRow({ constraint, registry, onChange, onDelete }: Readonly<ConstraintRowProps>) {
  ...
  return (
    <tr className="precond-policy__row">
      <td>
        <select
          className="precond-policy__select precond-policy__left"
