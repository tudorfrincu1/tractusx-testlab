...
export type PanelTabId = "yaml" | "graph" | "sequence";

export const PANEL_TABS: { id: PanelTabId; label: string; icon: ReactNode }[] = [
  { id: "yaml", label: "YAML Editor", icon: <EditNoteIcon sx={{ fontSize: 14 }} /> },
  { id: "graph", label: "Graph", icon: <AccountTreeIcon sx={{ fontSize: 14 }} /> },
  { id: "sequence", label: "Sequence", icon: <SwapHorizIcon sx={{ fontSize: 14 }} /> },
];

export interface PanelTabBarProps {
  activeTab: PanelTabId;
  onTabChange: (tab: PanelTabId | "none") => void;
  isReadOnly: boolean;
