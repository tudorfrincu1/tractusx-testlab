...
import "./forms/MetadataSection.css";
...
export function MetadataSection() {
  ...
  return (
    <SectionCard title="Metadata">
      <div className="metadata-section__grid">
        <InlineField
          label="Name"
          value={tck.name}
        ...
        />
        <div className="metadata-section__description-col">
          <InlineField
            label="Description"
      ...
      <div className="metadata-section__tags-row">
        <StandardsField
