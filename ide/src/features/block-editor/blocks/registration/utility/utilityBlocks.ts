  ...
  Blockly.Blocks["unsupported_step"] = {
    init(this: Block) {
      this.appendDummyInput()
        ...
        .appendField("Unsupported Step");
      this.appendDummyInput()
        .appendField("id:")
        .appendField(new Blockly.FieldTextInput(""), "STEP_ID");
      this.appendDummyInput()
        .appendField("\u26A0 This step type is not yet supported in the visual editor");
      // ORIGINAL_TYPE, PARAMS_JSON, STEP_DESCRIPTION stored in block.data (JSON)
      // This ensures round-trip serialization without rendering hidden fields.
      this.data = JSON.stringify({ originalType: "", paramsJson: "{}", stepDescription: "" });
      this.setPreviousStatement(true, "step");
      this.setNextStatement(true, "step");
