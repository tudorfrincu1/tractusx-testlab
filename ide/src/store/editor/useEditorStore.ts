...
interface TestLabState {
  ...
  /** Network detail overlay state */
  networkDetailEntry: NetworkEntry | null;
  setNetworkDetailEntry: (entry: NetworkEntry) => void;
  clearNetworkDetailEntry: () => void;
...
export const useEditorStore = create<TestLabState>((set, get) => {
  ...
  return {
    ...
    networkDetailEntry: null,
    setNetworkDetailEntry: (entry) => set({ networkDetailEntry: entry }),
    clearNetworkDetailEntry: () => set({ networkDetailEntry: null }),
