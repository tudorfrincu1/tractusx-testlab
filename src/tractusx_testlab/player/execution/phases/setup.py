...
"""Setup phase runner — stops on first failure, evaluates conditions."""
...
async def run_setup(
    ...
    return await _run_phase(script, context, job_id, monitor, jobs, _SETUP_CONFIG)
